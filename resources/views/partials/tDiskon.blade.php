...
<head>
    ...
    <title>Data Diskon | Kaidoo Store </title>
...
<script>
    ...
    $('.delete').click( function() {
        var diskonid = $(this).attr('data-id');
        var namadiskon = $(this).attr('data-nama');
        Swal.fire({
            title: "Yakin menghapus data?",
            text: "Anda akan menghapus diskon "+namadiskon+" ",
            icon: "warning",
            ...
            if (result.isConfirmed) {
                window.location = "/diskon/delete/"+diskonid+""
                Swal.fire({
                title: "Dihapus!",
