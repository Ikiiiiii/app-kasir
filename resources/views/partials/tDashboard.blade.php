            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu active">
                        <a href="/dashboard" aria-expanded="" class="dropdown-toggle">
                            <div class="">
                            ...
                            <div class="widget-one widget">
                                <div class="widget-content">
                                    <div class="w-numeric-value">
                                        ...
                                        <div class="w-content">
                                            <span class="w-value">2,952</span>
                                            <span class="w-numeric-title">Return Orders</span>
                                        </div>
                                    </div>
                                    <div class="w-chart">
                            ...
                            <div class="widget widget-wallet-one">
                                ...
                                <ul class="list-group list-group-media">
                                    <li class="list-group-item ">
                                        <div class="media">
                                            <div class="me-3">
                                                <img alt="avatar" src="https://designreset.com/equation/html/src/assets/img/netflix.svg" class="img-fluid rounded-circle">
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <li class="list-group-item">
                                        <div class="media">
                                            <div class="me-3">
                                                <img alt="avatar" src="https://designreset.com/equation/html/src/assets/img/apple-app-store.svg" class="img-fluid rounded-circle">
                                            </div>
                                            <div class="media-body">
                                ...
                                <div class="widget-content">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><div class="td-content customer-name"><img src="../src/assets/img/profile-13.jpg" alt="avatar"><span>Luke Ivory</span></div></td>
                                                ...
                                                <tr>
                                                    <td><div class="td-content customer-name"><img src="../src/assets/img/profile-7.jpg" alt="avatar"><span>Andy King</span></div></td>
                                                ...
                                                <tr>
                                                    <td><div class="td-content customer-name"><img src="../src/assets/img/profile-10.jpg" alt="avatar"><span>Laurie Fox</span></div></td>
                                                ...
                                                <tr>
                                                    <td><div class="td-content customer-name"><img src="../src/assets/img/profile-5.jpg" alt="avatar"><span>Ryan Collins</span></div></td>
                                                ...
                                                <tr>
                                                    <td><div class="td-content customer-name"><img src="../src/assets/img/profile-4.jpg" alt="avatar"><span>Irene Collins</span></div></td>
                                                ...
                                                <tr>
                                                    <td><div class="td-content customer-name"><img src="../src/assets/img/profile-11.jpg" alt="avatar"><span>Sonia Shaw</span></div></td>
